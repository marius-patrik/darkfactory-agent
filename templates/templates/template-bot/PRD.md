...
> This file is the **source of truth** for template-bot. The backlog, branches, PRs, and releases are derived from it. Edits to this file are the primary way to steer the product.
