...
| --- | --- | --- | --- |
| `packages/core` | `core` | Ubuntu, Windows | TypeScript types/imports, generated contract freshness, Python imports, Go tests |
| `packages/gateway` | `gateway` | Ubuntu | uv lock sync, lint, types, all non-live tests, packaging smoke, build |
