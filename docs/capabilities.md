...
The `tools/capabilities/global/` `skills/`, `plugins/`, `hooks/`, `roles/`, and
...
`ANDROMEDA_HOME/skills`, activates the single Rommie identity, and records exact
...
`ANDROMEDA_HOME/identity/prompts/<role>.md`.
