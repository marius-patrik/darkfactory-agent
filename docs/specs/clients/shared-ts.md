...
> The root `PRD.md` is the product authority. This file records the shared-ts
> component planning boundary; GitHub issues are the execution lane.

## Vision

Define the product vision here, aligned with the Andromeda root product context.
