...
| Managed provider invocation and startup-memory injection | `packages/clients/cli/manager/src/session-adapters.ts` |
| State roots, provider registry, memory, CLI, packages, and orchestration policy | `packages/clients/cli/manager/src` |
