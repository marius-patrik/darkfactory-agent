...
import { readDataRepos, upsertDataRepo } from "../data-repos";
import { ensureSharedState, sharedState, systemDataPath } from "../state";
...
describe("os doctor acceptance additions", () => {
  ...
  test("configuredProfiles reads profiles from container records", async () => {
    ...
    try {
      ...
      const { ensureContainerRecord } = await import("../os-lifecycle");
