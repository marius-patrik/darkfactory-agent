...
const PUBLIC_OPERATIONAL_IDENTIFIERS = new Set([
  ...
  "src/manager/src/runner-lifecycle.ts",
  "src/manager/src/session-adapters.ts",
  "src/manager/src/adapters.ts",
  "src/manager/src/route-probe.ts",
  "src/manager/src/process-command.ts",
  "src/manager/test/runner-lifecycle.test.ts",
