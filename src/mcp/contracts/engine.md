...
> **Implementation:** `src/server/inference/python-agent/agent/engines/contract.py`

Every inference engine sits behind a single Python Protocol.  inferctl
(`src/server/inference/services/inferctl`, Go) is the controller; the Python contract is the seam
...
`src/server/inference/python-agent/agent/engines/contract.py` implementation and
...
`src/server/inference/python-agent/agent/engines/contract.py` and use Python >=
...
1. Create `src/server/inference/python-agent/agent/engines/dynamo.py`, `class DynamoAdapter`.
...
*This document tracks `src/server/inference/python-agent/agent/engines/contract.py`. It must be updated
