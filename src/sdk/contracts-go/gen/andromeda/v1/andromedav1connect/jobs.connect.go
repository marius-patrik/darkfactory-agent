...
const (
	...
	JobServiceName = "andromeda.v1.JobService"
	// DomainServiceName is the fully-qualified name of the DomainService service.
	DomainServiceName = "andromeda.v1.DomainService"
)
...
const (
	...
	JobServiceListJobsProcedure = "/andromeda.v1.JobService/ListJobs"
	// JobServiceGetJobStatusProcedure is the fully-qualified name of the JobService's GetJobStatus RPC.
	JobServiceGetJobStatusProcedure = "/andromeda.v1.JobService/GetJobStatus"
	// DomainServiceListDomainsProcedure is the fully-qualified name of the DomainService's ListDomains
	// RPC.
	DomainServiceListDomainsProcedure = "/andromeda.v1.DomainService/ListDomains"
	// DomainServiceGetDomainStatusProcedure is the fully-qualified name of the DomainService's
	// GetDomainStatus RPC.
	DomainServiceGetDomainStatusProcedure = "/andromeda.v1.DomainService/GetDomainStatus"
)

// JobServiceClient is a client for the andromeda.v1.JobService service.
...
// NewJobServiceClient constructs a client for the andromeda.v1.JobService service. By default, it
...
func NewJobServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) JobServiceClient {
	...
	jobServiceMethods := v1.File_andromeda_v1_jobs_proto.Services().ByName("JobService").Methods()
...
// ListJobs calls andromeda.v1.JobService.ListJobs.
...
// GetJobStatus calls andromeda.v1.JobService.GetJobStatus.
...
// JobServiceHandler is an implementation of the andromeda.v1.JobService service.
...
func NewJobServiceHandler(svc JobServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/andromeda.v1.JobService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedJobServiceHandler) ListJobs(context.Context, *connect.Request[v1.ListJobsRequest]) (*connect.Response[v1.ListJobsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("andromeda.v1.JobService.ListJobs is not implemented"))
}
...
func (UnimplementedJobServiceHandler) GetJobStatus(context.Context, *connect.Request[v1.GetJobStatusRequest]) (*connect.Response[v1.GetJobStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("andromeda.v1.JobService.GetJobStatus is not implemented"))
}

// DomainServiceClient is a client for the andromeda.v1.DomainService service.
...
// NewDomainServiceClient constructs a client for the andromeda.v1.DomainService service. By
...
func NewDomainServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) DomainServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	domainServiceMethods := v1.File_andromeda_v1_jobs_proto.Services().ByName("DomainService").Methods()
...
// ListDomains calls andromeda.v1.DomainService.ListDomains.
...
// GetDomainStatus calls andromeda.v1.DomainService.GetDomainStatus.
...
// DomainServiceHandler is an implementation of the andromeda.v1.DomainService service.
...
func NewDomainServiceHandler(svc DomainServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/andromeda.v1.DomainService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDomainServiceHandler) ListDomains(context.Context, *connect.Request[v1.ListDomainsRequest]) (*connect.Response[v1.ListDomainsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("andromeda.v1.DomainService.ListDomains is not implemented"))
}
...
func (UnimplementedDomainServiceHandler) GetDomainStatus(context.Context, *connect.Request[v1.GetDomainStatusRequest]) (*connect.Response[v1.GetDomainStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("andromeda.v1.DomainService.GetDomainStatus is not implemented"))
}
