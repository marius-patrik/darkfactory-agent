...
2. Read the outgoing provider transcript from the last canonical event through now. Classify an unexpired canonical lease as live regardless of transcript silence; classify an expired lease with no later transcript activity as stale; classify an expired lease with later transcript activity as expired but reconciliation-required. Transcript activity never extends the lease, but reconcile its work before takeover. Treat provider-local handoffs as evidence, never authority.
