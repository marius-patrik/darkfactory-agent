...
const (
	...
	HealthServiceName = "agent_os.v1.HealthService"
)
...
const (
	...
	HealthServiceGetHealthProcedure = "/agent_os.v1.HealthService/GetHealth"
)

// HealthServiceClient is a client for the agent_os.v1.HealthService service.
type HealthServiceClient interface {
	GetHealth(context.Context, *connect.Request[v1.GetHealthRequest]) (*connect.Response[v1.GetHealthResponse], error)
}

// NewHealthServiceClient constructs a client for the agent_os.v1.HealthService service. By default,
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_agent_os_v1_health_proto.Services().ByName("HealthService").Methods()
...
// GetHealth calls agent_os.v1.HealthService.GetHealth.
...
// HealthServiceHandler is an implementation of the agent_os.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/agent_os.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) GetHealth(context.Context, *connect.Request[v1.GetHealthRequest]) (*connect.Response[v1.GetHealthResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("agent_os.v1.HealthService.GetHealth is not implemented"))
}
