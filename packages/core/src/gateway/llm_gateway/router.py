...
from llm_gateway.registry import ModelEntry, ModelRegistry, ActiveRoleManager, generate_request_id, ROLE_NAMES
...
class Router:
    ...
    def _resolve_role(self, role: str) -> ModelEntry | None:
        ...
        if not pool:
            ...
            # have no model registered for it. Return None here so
