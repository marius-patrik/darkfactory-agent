...
# 'conversation' remains an internal routing role: conv-* models are reachable
# by model ID, but the alias is not on the switcher surface. 'embedding' is also
# hidden until a supported embedding model is registered.
ROLE_ALIASES = ("general", "coding", "judge")
