...
> This file is the **source of truth** for core. The backlog, branches, PRs, and releases are derived from it. Edits to this file are the primary way to steer the product.

## Vision

Consolidated core package for the agents-mono topology. Exposes the agents CLI and aggregates manager, core, harness, inference, gateway, plugin, and dream domains.
