# marius-patrik/dream PRD

> This file is the **source of truth** for marius-patrik/dream. The backlog, branches, PRs, and releases are derived from it. Edits to this file are the primary way to steer the product.

## Vision

The **Dream** package is a standalone plugin that contains only the `dream` workflow for temporal replay and retrospective continuity.
